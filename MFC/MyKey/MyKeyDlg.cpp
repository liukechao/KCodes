// MyKeyDlg.cpp : implementation file
//
...
CMyKeyDlg::CMyKeyDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMyKeyDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMyKeyDlg)
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMyKeyDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMyKeyDlg, CDialog)
	//{{AFX_MSG_MAP(CMyKeyDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_KEYDOWN()
...
void CMyKeyDlg::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
	...
	char strnChar[10],strnRepCnt[10],strnFlags[10];
