...
void CMyIEDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_MY_EXPLORER, m_ie);
	DDX_Text(pDX, IDC_URL_EDIT, m_UrlEdit);
	//}}AFX_DATA_MAP
}
...
void CMyIEDlg::OnOkButton() 
{
	// TODO: Add your control notification handler code here
	UpdateData(true);
	m_ie.Navigate(m_UrlEdit,NULL,NULL,NULL,NULL);
}

BEGIN_EVENTSINK_MAP(CMyIEDlg, CDialog)
    //{{AFX_EVENTSINK_MAP(CMyIEDlg)
	ON_EVENT(CMyIEDlg, IDC_MY_EXPLORER, 262 /* WindowSetResizable */, OnWindowSetResizableMyExplorer, VTS_BOOL)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()

void CMyIEDlg::OnWindowSetResizableMyExplorer(BOOL Resizable) 
{
	// TODO: Add your control notification handler code here
}

void CMyIEDlg::OnSize(UINT nType, int cx, int cy) 
{
